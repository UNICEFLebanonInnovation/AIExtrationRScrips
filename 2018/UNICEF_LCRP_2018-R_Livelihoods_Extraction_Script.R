...
outfilname<- paste('../', Sys.Date(), "_Sector_LIVELIHOODS.csv", sep="")
...
outfilname<- paste('../', Sys.Date(), "_UNICEF_PBI_LIVELIHOODS.csv", sep="")
...
outfilname<- paste('../', Sys.Date(), "_UNICEF_LIVELIHOODS.csv", sep="")
